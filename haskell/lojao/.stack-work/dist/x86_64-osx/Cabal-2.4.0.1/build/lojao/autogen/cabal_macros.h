...
/* package lojao-0.1.0.0 */
#ifndef VERSION_lojao
#define VERSION_lojao "0.1.0.0"
#endif /* VERSION_lojao */
#ifndef MIN_VERSION_lojao
#define MIN_VERSION_lojao(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lojao */
...
#define CURRENT_COMPONENT_ID "lojao-0.1.0.0-EjiHh5KLWcDDaWHZPpzIFl-lojao"
